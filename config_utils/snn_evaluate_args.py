...
def obtain_evaluate_args():
    ...
    parser.add_argument('--model_fname', type=str, default='', help='name of model')
    ...
    parser.add_argument('--filter_multiplier', type=int, default=32)    # retrain use 32,search use 8
    ...
    parser.add_argument('--num_layer', type=int, default=6, help='num_layer')
    parser.add_argument('--autodeeplab', type=str, default='test')
